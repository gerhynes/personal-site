...
I chose to build the app with [Gatsby](https://www.gatsbyjs.com/) since it's a technology I want to get better at, plus it makes it relatively painless to turn your app into a Progressive Web App using `gatsby-plugin-manifest` and `gatsby-plugin-offline`.
