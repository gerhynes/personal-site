...
date: "2021-08-16"
slug: reading-habit
repoUrl: https://github.com/GK-Hynes/reading-habit
siteUrl: https://reading-habit.vercel.app/
image: ./reading-habit.png
---
...
![Book lists for 2020 and 2021](./book-lists.png)
...
Importantly, documents in Fauna are stored with a Ref containing their collection and a unique id. The document's data is then stored in a data object.
...
![App interface when no books have been added](./empty-state.png)
