...
Is there an error message yelling at you? Great! It might not seem it, but error messges are there to help you. It would be worse if your code just failed silently and left you none the wiser.
...
If you got an error message and it wasn't enought to tell you what was wrong with your code, it might still prove useful in helping you find a resource that can help you.
