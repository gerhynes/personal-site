...
description: "There are up-to-date Scala resources for beginners. Here are a few I found helpful."
published: true
tags: ["Scala"]
image: ./resources-for-learning-scala.png
---
...
![Scala at Lightspeed](./scala-at-lightspeed.png)

Link: https://youtu.be/-8V6bMjThNo
...
![Effective Programming in Scala](./effective-programming-in-scala.png)
...
![The official Scala docs](./scala-docs.png)
...
![Get Programming with Scala](./get-programming-with-scala.png)
...
![This Week in Scala](./this-week-in-scala.png)

Link: https://medium.com/disney-streaming/tagged/scala
...
![Exercism Scala Track](./exercism-scala-track.png)
...
![Scala subreddit](./scala-subreddit.png)

Link: https://www.reddit.com/r/scala/
